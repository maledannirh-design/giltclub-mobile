export function showVerifiedWarningPopup(){
  ...
  const key =
    "verifiedPopupDismissed_warning_" +
  ...
  <div class="verified-popup-backdrop">
    <div class="verified-popup-box">
      ...
      <p>Verified anda akan segera dilepas.</p>

      <p>
      Mohon lakukan pengisian saldo ke batas minimal saldo tersisa
      <b>Rp250.000</b> sebelum tanggal <b>7</b>.
      </p>
      ...
      <button id="verified-warning-close">Mengerti</button>
  ...
  document.getElementById("verified-warning-close").onclick = () => {
